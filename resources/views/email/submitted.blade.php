                    ...
                    <tr>
                        <td style="background:#ffffff;border-radius:0 0 16px 16px;overflow:hidden;">
                                ...
                                <tr>
                                    <td style="background-color:#1d3577;padding:36px 44px 32px;">
                                        ...
                                        <p
                                            ...
                                            Appointment Request<br>Successfully Received</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td
                                        style="background-color:#fff9ee;border-top:1px solid #f0dcaa;border-bottom:1px solid #f0dcaa;padding:11px 44px;">
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td valign="middle"
                                                    style="width:28px;height:28px;background-color:#f5a623;border-radius:50%;text-align:center;font-size:13px;line-height:28px;">
                                                    ⏳</td>
                                                <td valign="middle" style="padding-left:10px;">
                                                    <span
                                                        style="font-size:11.5px;font-weight:700;color:#b87a0a;letter-spacing:1.2px;text-transform:uppercase;">Pending
                                                        Review</span>
                                                    <span style="font-size:11.5px;color:#a07428;"> — Awaiting
                                                        confirmation from the administration</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="padding:36px 44px 32px;">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                            ...
                                            <tr>
                                                <td width="33%" align="center"
                                                    style="background-color:#1d3577;padding:14px 12px;border-right:1px solid #dde4f0;">
                                                    <table cellpadding="0" cellspacing="0" border="0"
                                                ...
                                                <td width="33%" align="center"
                                                    style="background-color:#faf8f4;padding:14px 12px;border-right:1px solid #dde4f0;">
                                                    <table cellpadding="0" cellspacing="0" border="0"
                                                        style="margin:0 auto 7px;">
                                                        <tr>
                                                            <td
                                                                style="width:30px;height:30px;background-color:#dde4f0;border-radius:50%;text-align:center;font-size:12px;font-weight:700;color:#8892aa;line-height:30px;">
                                                                2</td>
                                                        </tr>
                                                    </table>
                                                    <p style="margin:0;font-size:10.5px;font-weight:600;color:#8892aa;">
                                                        Under Review</p>
                                                </td>
                                                <td width="33%" align="center"
                                                    style="background-color:#faf8f4;padding:14px 12px;">
                                                    <table cellpadding="0" cellspacing="0" border="0"
                                                        style="margin:0 auto 7px;">
                                                        <tr>
                                                            <td
                                                    ...
                                                    <p
                                                        style="margin:0;font-size:10.5px;font-weight:600;color:#8892aa;">
                                                        Confirmed</p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        {{-- <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                            ...
                                            <tr>
                                                <td style="height:1px;background:#dde4f0;font-size:0;">&nbsp;</td>
                                                <td
                                                    style="padding:0 12px;white-space:nowrap;font-size:10px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#8892aa;">
                                        ...
                                        <!-- ── DETAILS CARD ── -->
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                            style="border:1px solid #dde4f0;border-radius:12px;overflow:hidden;margin-bottom:28px;">

                                            <!-- Card Header -->
                                            <tr>
                                                <td colspan="2"
                                                    style="background-color:#1d3577;padding:12px 20px;">
                                                    <span style="font-size:14px;">📋&nbsp;</span>
                                                    <span
                                                        style="font-size:11px;font-weight:700;letter-spacing:1.8px;text-transform:uppercase;color:rgba(255,255,255,0.88);">Appointment
                                                        Details</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="background-color:#fafbfe;">
                                                <td style="padding:12px 8px 12px 18px;width:44px;" valign="top">
                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            <td
                                                                style="width:28px;height:28px;background-color:#eef2fc;border-radius:7px;text-align:center;font-size:13px;line-height:28px;">
                                                                🔖</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td style="padding:12px 20px 12px 6px;border-bottom:1px solid #dde4f0;"
                                                    valign="top">
                                                    <p
                                                        style="margin:0 0 4px;font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#8892aa;">
                                                        Reference Number</p>
                                                    <span
                                                        style="display:inline-block;background-color:#1d3577;color:#ffffff;font-size:13px;font-weight:600;padding:3px 14px;border-radius:20px;">#{{ $bookAppointmentUser->reference_number }}</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="background-color:#fafbfe;">
                                                ...
                                                <td style="padding:12px 20px 12px 6px;border-bottom:1px solid #dde4f0;"
                                                    ...
                                                    <p
                                                        style="margin:0 0 4px;font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#8892aa;">
                                                        Where to go?</p>
                                                    <p style="margin:0;font-size:14px;color:#1a1f35;font-weight:500;">

                                                        @if ($bookAppointmentUser->role === 'cashier')
                                                            (Cashier's Office)
                                                        @elseif($bookAppointmentUser->role === 'none')
                                                            (Admission Office)
                                                        @elseif($bookAppointmentUser->role === 'registrar')
                                                            (Registrar's Office)
                                                        @elseif($bookAppointmentUser->role === 'guidance')
                                                            (Guidance Office)
                                                        @elseif($bookAppointmentUser->role === 'elem')
                                                            (Junior High Principal's Office)
                                                        @elseif($bookAppointmentUser->role === 'sr')
                                            ...
                                            <tr style="background-color:#ffffff;">
                                                ...
                                                <td style="padding:12px 20px 12px 6px;border-bottom:1px solid #dde4f0;"
                                                    ...
                                                    <p
                                                        ...
                                                        Requested Date</p>
                                                    <p style="margin:0;font-size:14px;color:#1a1f35;font-weight:500;">
                                                        {{ $bookAppointmentUser->appointment_date }}</p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="background-color:#fafbfe;">
                                                ...
                                                <td style="padding:12px 20px 12px 6px;border-bottom:1px solid #dde4f0;"
                                                    ...
                                                    <p
                                                        ...
                                                        Requested Time</p>
                                                    <p style="margin:0;font-size:14px;color:#1a1f35;font-weight:500;">
                                                        {{ $bookAppointmentUser->appointment_time }}</p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="background-color:#ffffff;">
                                                ...
                                                <td style="padding:12px 20px 12px 6px;border-bottom:1px solid #dde4f0;"
                                                    ...
                                                    <p
                                                        style="margin:0 0 4px;font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#8892aa;">
                                                        Purpose of Appointment</p>
                                                    <p style="margin:0;font-size:14px;color:#1a1f35;font-weight:500;">
                                                        {{ $bookAppointmentUser->purpose }}</p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="background-color:#fafbfe;">
                                                ...
                                                <td style="padding:12px 20px 12px 6px;" valign="top">
                                                    <p
                                                        style="margin:0 0 4px;font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#8892aa;">
                                                        Submitted On</p>
                                                    <p style="margin:0;font-size:14px;color:#1a1f35;font-weight:500;">
                                                        {{ $bookAppointmentUser->created_at->format('F j, Y, g:i A') }}
                                                    </p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:20px 22px 20px 10px;" valign="top">
                                                    ...
                                                    <p style="margin:0;font-size:13px;color:#3a4460;line-height:1.75;">
                                                        ...
                                                        Please monitor your inbox closely. For urgent concerns, contact
                                                        us directly at the school office.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
